...
#    Updated: 2019/06/21 08:52:40 by smadesi          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_atoi.c \ft_bzero.c \ft_isalnum.c \ft_isalpha.c \ft_isascii.c \ft_isdigit.c \ft_isprint.c \
	  ...
	  ft_strmap.c \ft_strmapi.c \ft_putchar.c \ft_putstr.c \ft_strequ.c \ft_strnequ.c \ft_strsub.c \
	  ft_strjoin.c \ft_strtrim.c \ft_strsplit.c \ft_putendl_fd.c \ft_putnbr_fd.c \ft_putendl.c \
	  ft_putnbr.c \ft_putchar_fd.c \ft_putstr_fd.c \ft_itoa.c
...
OBJ = ft_atoi.o \ft_bzero.o \ft_isalnum.o \ft_isalpha.o \ft_isascii.o \ft_isdigit.o \ft_isprint.o \
	  ...
	  ft_strmap.o \ft_strmapi.o \ft_putchar.o \ft_putstr.o \ft_strequ.o \ft_strnequ.o \ft_strsub.o \
	  ft_strjoin.o \ft_strtrim.o \ft_strsplit.o \ft_putendl_fd.o \ft_putnbr_fd.o \ft_putchar_fd.o \
	  ft_putstr_fd.o \ft_putendl.o \ft_putnbr.o \ft_itoa.o 
